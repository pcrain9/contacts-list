...
function DeleteScreen(props: userDeletedThruProps) {
  ...
  return (
    <div id="delete-screen-container">
      <h2 id="delete-screen-text">Are you sure you want to delete {user.firstName} {user.lastName}?</h2>
      <div id="delete-button-container">
        <div
          id="delete-button-cancel"
          onClick={() => {handleUserCancelledReducer("CANCEL")}}
          >Cancel</div>
        <button
          id="delete-button-confirm"
          onClick={() => {handleUserCancelledReducer("CONFIRM")}}
          >Delete</button>
      </div>
    </div>
  );
